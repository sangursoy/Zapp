...
SELECT 'e8922fbb-d439-44cc-a74b-9cdd17bdc085', category
FROM (VALUES 
  ('Technology'),
  ('Entertainment'),
  ('Science'),
...
SELECT 'e8922fbb-d439-44cc-a74b-9cdd17bdc085', category, points, level
FROM (VALUES 
  ('Technology', 250, 3),
  ('Entertainment', 150, 2),
  ('Science', 175, 2),
...
SELECT 'e8922fbb-d439-44cc-a74b-9cdd17bdc085', category, subcategory
FROM (VALUES 
